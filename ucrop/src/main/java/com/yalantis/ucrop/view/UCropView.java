...
public class UCropView extends FrameLayout {
    ...
    public UCropView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mOverlayIv = findViewById(R.id.iv_overlay);
     ...
     * @param isFront
     */
    public void setOverlaybg(boolean isFront) {
        if (isFront) {
            mOverlayIv.setImageResource(R.drawable.bg_front);
        } else {
            mOverlayIv.setImageResource(R.drawable.bg_background);
        }
