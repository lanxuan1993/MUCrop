...
public class UCrop {
    ...
    public static final String EXTRA_OVERLAY_BG = EXTRA_PREFIX + ".OverlayBg";
    ...
    public UCrop withOverlay(boolean isFront) {
        mCropOptionsBundle.putBoolean(EXTRA_OVERLAY_BG, isFront);
        return this;
    }
